...
#ifndef YY_YY_CPPCALC_TAB_HH_INCLUDED
# define YY_YY_CPPCALC_TAB_HH_INCLUDED
...
#line 162 "cppcalc.tab.hh" // lalr1.cc:377
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        SMALLER_THAN = 280,
        BIGGER_THAN = 281,
        SMALLER_THAN_OR_EQUAL = 282,
        BIGGER_THAN_OR_EQUAL = 283,
        pidentifier = 284,
        num = 285,
        SUB = 286,
        ADD = 287,
  ...
  private:
    ...
    cppcalc (const cppcalc&);
    cppcalc& operator= (const cppcalc&);
...
#endif // !YY_YY_CPPCALC_TAB_HH_INCLUDED
